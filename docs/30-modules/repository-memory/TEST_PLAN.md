...
- Confirm roadmap keeps future adoption reviewable rather than silently accepting inferred memory.
- Confirm roadmap defines drift as mismatch with accepted repository memory.
