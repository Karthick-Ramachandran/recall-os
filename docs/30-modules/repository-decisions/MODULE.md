...
- Accepted repository-level decisions.
- ADR relationship to implementation.
- Drift definition against accepted repository memory.
...
Drift means mismatch with accepted repository memory.
