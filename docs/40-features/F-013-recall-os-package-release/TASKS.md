# Tasks: Recall OS Package Release
...
- Recall OS naming is consistent across tracked code, docs, tests, and generated output.
- `.recall/config.json` is the only supported config path.
...
- Built `recall` binary runs help, init, and doctor in tests.
