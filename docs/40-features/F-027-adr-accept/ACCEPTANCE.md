...
- `recall adr accept <slug>` promotes `docs/adrs/proposed/ADR-PROPOSED-<slug>.md` to a numbered
...
- The command accepts either the slug (`mcp-figma`) or the full proposed name (`ADR-PROPOSED-mcp-figma`).
