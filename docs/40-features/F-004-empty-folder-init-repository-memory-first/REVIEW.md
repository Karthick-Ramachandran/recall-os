...
- No product drift found. Product docs now define Persist OS as repository memory first and
  empty-folder init as first-class.
- No architecture drift found. Architecture docs keep neutral init, architecture-neutral core, and
  no-runtime P1.7 scope.
- No opinion-pack drift found. Presets remain optional guidance and proposed decisions only.
- No adoption drift found. Legacy adoption is documented as future `persist adopt`.
...
- `persist init` remains neutral and architecture-opinion-free.
